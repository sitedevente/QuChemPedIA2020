              ...
              r(e, null, [
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    for (
                      var n = e.slice().sort(), r = t.slice().sort(), a = 0;
                      a < n.length;
                      a++
                    )
                      if (n[a] !== r[a]) return !1;
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    for (
                      var n = Array(e.length + t.length), r = 0;
                      r < e.length;
                      r++
                    )
                      n[r] = e[r];
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      ...
                      var r = n + e + i;
                      this.attachedPseudoElements[r]
                        ? (this.attachedPseudoElements[r].count += 1)
                        : (this.attachedPseudoElements[r] = {
                            element: e,
                            count: 1,
                            hydrogenCount: n,
                  ...
                  },
                  {
                    key: "addAnchoredRing",
                    value: function (e) {
                      r.contains(this.anchoredRings, { value: e }) ||
                    ...
                    s.save(),
                      ...
                      o
                        ? (r
                          ...
                          this.drawDebugText(e, t, l))
                        : r
                        ? ((s.fillStyle = i), s.fill())
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (
                      ...
                      var p = o.add(
                          h,
                          o.multiplyScalar(r[0], this.halfBondThickness)
                        ),
                        t = o.add(
                          c,
                          o.multiplyScalar(r[0], 1.5 + this.halfBondThickness)
                        ),
                        u = o.add(
                          c,
                          o.multiplyScalar(r[1], 1.5 + this.halfBondThickness)
                        ),
                        v = o.add(
                          h,
                          o.multiplyScalar(r[1], this.halfBondThickness)
                        );
                      n.beginPath(),
                        n.moveTo(p.x, p.y),
                        n.lineTo(t.x, t.y),
                        n.lineTo(u.x, u.y),
                        n.lineTo(v.x, v.y);
                      var y = this.ctx.createRadialGradient(
                        l.x,
                        l.y,
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (
                      ...
                      for (
                        var y = e.getLength(),
                          m = 1.25 / (y / (3 * this.opts.bondThickness)),
                          f = !1,
                          b = 0;
                        1 > b;
                        b += m
                ...
                },
                {
                  ...
                  value: function (e, t, n, i, o, l, s, g) {
                    ...
                    0 < g &&
                      ((y = g.toString()),
                      (u.font = this.fontSmall),
                      (m = u.measureText(y).width)),
                      1 === s &&
                        "N" === n &&
                        d.hasOwnProperty("0O") &&
                        d.hasOwnProperty("0O-1") &&
                        ((d = {
                          "0O": {
                            element: "O",
                            count: 2,
                    ...
                    for (var T in d)
                      if (d.hasOwnProperty(T)) {
                        ...
                        (k = 0),
                          ...
                          0 !== E &&
                            ((O = this.getChargeText(E)),
                            (V = u.measureText(O).width)),
                          (C = 0),
                        ...
                        (u.fillStyle = this.getColor(P)),
                          ...
                          1 < B &&
                            0 < L &&
                            ("left" === o
                              ? ((x -= I), u.fillText(")", H + x, z))
                              : (u.fillText("(", H + r, z), (r += w))),
                          "left" === o
                            ? ((x -= D), u.fillText(P, H + x, z))
                            : (u.fillText(P, H + r, z), (r += D)),
                          0 < L &&
                            ("left" === o
                              ? ((x -= k + C),
                                u.fillText("H", H + x, z),
                          ...
                          1 < B &&
                            0 < L &&
                            ("left" === o
                              ? ((x -= w), u.fillText("(", H + x, z))
                              : (u.fillText(")", H + r, z), (r += I))),
                          (u.font = this.fontSmall),
                          1 < B &&
                            ("left" === o
                              ? u.fillText(
            ...
            return (
              a(e, [
                          ...
                          for (var r in i)
                            Object.prototype.hasOwnProperty.call(i, r) &&
                              (t[r] =
                                n &&
                                "[object Object]" ===
                                  Object.prototype.toString.call(i[r])
                                  ? e.extend(!0, t[r], i[r])
                                  : i[r]);
                        },
                        o;
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    if (
                      ...
                      (this.ringIdCounter = 0),
                      (this.ringConnectionIdCounter = 0),
                      (this.graph = new m(e, this.opts.isomeric)),
                      (this.rings = []),
                            ...
                            if (c.value > this.opts.overlapSensitivity) {
                              ...
                              if (1 === f.length) {
                                var b = this.graph.vertices[f[0]],
                                  x = b.position.getRotateAwayFromAngle(
                                    p.position,
                                    v.position,
                                    g.toRad(120)
                                  );
                                ...
                                if (
                                  1 === C.value.rings.length &&
                                  1 === S.value.rings.length
                                ) {
                                  if (C.value.rings[0] !== S.value.rings[0])
                                    continue;
                                } else if (
                                  0 !== C.value.rings.length ||
                                  0 !== S.value.rings.length
                                )
                                  continue;
                                else {
                                  var R = C.position.getRotateAwayFromAngle(
                                      p.position,
                                      v.position,
                                      g.toRad(120)
                                    ),
                                    A = S.position.getRotateAwayFromAngle(
                                      p.position,
                                      v.position,
                                      g.toRad(120)
                                    );
                  ...
                  value: function () {
                    for (
                      ...
                      if (((i = this.graph.vertices[r]), !!i.value.isDrawn))
                        for (
                          ...
                          if (
                            ((o = this.graph.vertices[a]), !!o.value.isDrawn)
                          ) {
                    ...
                    if (!isNaN(g)) {
                      ...
                      for (var r = 0; r < this.graph.vertices.length; r++)
                        r !== t &&
                          this.graph.vertices[r].position.rotateAround(
                            g,
                            this.graph.vertices[t].position
                          );
                      for (var r = 0; r < this.rings.length; r++)
                        this.rings[r].center.rotateAround(
                          g,
                          this.graph.vertices[t].position
                        );
                    }
                ...
                },
                {
                  ...
                  value: function () {
                    for (
                      var t = "", n = new Map(), e = 0, i;
                      e < this.graph.vertices.length;
                      e++
                    )
                      if (
                        ((i = this.graph.vertices[e].value),
                        n.has(i.element)
                          ? n.set(i.element, n.get(i.element) + 1)
                          : n.set(i.element, 1),
                        i.bracket &&
                          !i.bracket.chirality &&
                          (n.has("H")
                            ? n.set("H", n.get("H") + i.bracket.hcount)
                            : n.set("H", i.bracket.hcount)),
                        !i.bracket)
                      ) {
                ...
                },
                {
                  ...
                  value: function () {
                    for (
                      var e = new Map(), t = this.graph.vertices.length - 1, i;
                      0 <= t;
                      t--
                    )
                      if (
                        ((i = this.graph.vertices[t]),
                        0 !== i.value.ringbonds.length)
                      )
                ...
                },
                {
                  ...
                  value: function (e) {
                    for (
                      var t = new Set(), r = new Set(), a = new Set(), o = 0, i;
                      o < e.length;
                      o++
                    ) {
                      ...
                      for (var l = 0, s; l < i.neighbours.length; l++)
                        (s = i.neighbours[l]),
                          -1 === e.indexOf(s) && a.add(i.neighbours[l]);
                    }
                    var g = new Set(),
                      u = !0,
                      h = !1,
                    ...
                    try {
                      for (
                        ...
                        1 === f.value.rings.length || 1 === b.length
                          ? t.add(f.id)
                          : g.add(f.id);
                      }
                    } catch (e) {
                    ...
                    for (var o = 0; o < P.members.length; o++)
                      this.graph.vertices[P.members[o]].value.bridgedRing =
                        P.id;
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    for (var n = [], r = 0; r < e.value.rings.length; r++)
                      for (var i = 0; i < t.value.rings.length; i++)
                        e.value.rings[r] == t.value.rings[i] &&
                          n.push(e.value.rings[r]);
                    return n;
                  },
                },
                {
                  ...
                  value: function (e, t) {
                    for (
                      var n = this.getCommonRings(e, t), r = 0, a = null, o = 0;
                      o < n.length;
                      o++
                    ) {
                      ...
                      for (r = this.graph.vertices.length; --r > n; ) {
                        ...
                        if (o.value.isDrawn && a.value.isDrawn) {
                          ...
                          if (s < this.opts.bondLengthSq) {
                            var g =
                              (this.opts.bondLength - Math.sqrt(s)) /
                              this.opts.bondLength;
                            (e += g), (t[n] += g), (t[r] += g);
                          }
                        }
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    for (
                      var r = e.getNeighbours(t.id),
                        a = t.getNeighbours(e.id),
                        o = r.length,
                        l = a.length,
                        s = d.merge(r, a),
                        g = [0, 0],
                      ...
                      (i = this.graph.vertices[s[u]].position),
                        i.sameSideAs(e.position, t.position, n[0])
                          ? g[0]++
                          : g[1]++;
                    for (
                      var h = [0, 0], u = 0, c;
                      u < this.graph.vertices.length;
                      u++
                    )
                      (c = this.graph.vertices[u].position),
                ...
                },
                {
                  ...
                  value: function (e) {
                    for (
                      var t = e.getSize(), n = new l(0, 0), r = 0;
                      r < t;
                      r++
                    )
                  ...
                  value: function (e, t) {
                    for (
                      ...
                      for (var i = 0; i < e.rings.length; i++)
                        n[o] === e.rings[i].id &&
                          e.rings[i].getSize() < a &&
                          ((r = e.rings[i].center), (a = e.rings[i].getSize()));
                    return r;
                  },
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (
                      ...
                      this.graph.traverseBF(0, function (r) {
                        for (
                          var a = t.graph.getEdges(r.id), o = 0, i;
                          o < a.length;
                          o++
                        )
                      ...
                      for (var r = 0, i; r < this.rings.length; r++)
                        (i = this.rings[r]),
                  ...
                  value: function (e, t) {
                    ...
                    if (
                      ...
                      var h = r.position,
                        ...
                        p = d.clone(c);
                      if (
                        (p[0].multiplyScalar(10).add(h),
                        p[1].multiplyScalar(10).add(h),
                        "=" === i.bondType ||
                        ...
                        if (v) {
                          ...
                          (b = f.sameSideAs(
                            ...
                            ? new s(l.add(h, c[0]), l.add(a, c[0]), g, u)
                            : new s(l.add(h, c[1]), l.add(a, c[1]), g, u)),
                            b.shorten(
                              this.opts.bondLength -
                  ...
                  value: function (e) {
                    for (
                      ...
                      var n = this.graph.vertices[t],
                        ...
                        y = "C" === i.element;
                      if (
                        ("N" === i.element && i.isPartOfAromaticRing && (h = 0),
                        i.bracket &&
                          ((h = i.bracket.hcount),
                          (o = i.bracket.charge),
                          (s = i.bracket.isotope)),
                  ...
                  value: function () {
                    ...
                    for (var t = 0, n; t < e.length; t++) {
                      ...
                      for (var i = 0, r; i < n.rings.length; i++)
                        (r = n.rings[i]),
                          (this.originalRings[r.id].center = r.center);
                    }
                  ...
                  value: function (e) {
                    ...
                    if (!e.positioned) {
                      ...
                      var c = d,
                        ...
                        p = n ? n.id : null;
                      if (
                        (-1 === e.members.indexOf(p) &&
                          (n && (n.positioned = !1), (p = e.members[0])),
                        e.isBridged)
                      ) {
                        this.graph.kkLayout(
                          e.members.slice(),
                      ...
                      for (var y = 0, i; y < s.length; y++)
                        if (
                          ((i = this.getRing(s[y].neighbour)), !i.positioned)
                        ) {
                          var m = v.getVertices(
                            this.ringConnections,
                            e.id,
                          ...
                          if (2 === m.length) {
                            ...
                            var S = k[0];
                            l.subtract(t, k[1]).lengthSq() >
                              l.subtract(t, k[0]).lengthSq() && (S = k[1]);
                            var R = l.subtract(f.position, S),
                              A = l.subtract(b.position, S);
                            -1 === R.clockwise(A)
                              ? !i.positioned && this.createRing(i, S, f, b)
                              : !i.positioned && this.createRing(i, S, b, f);
                          } else if (1 === m.length) {
                            (e.isSpiro = !0), (i.isSpiro = !0);
                            var T = this.graph.vertices[m[0]],
                              w = l.subtract(t, T.position);
                            w.invert(), w.normalize();
                            var I = g.polyCircumradius(
                              this.opts.bondLength,
                              i.getSize()
                            );
                            w.multiplyScalar(I),
                      ...
                      for (var y = 0; y < e.members.length; y++)
                        for (
                          var P = this.graph.vertices[e.members[y]],
                            B = P.neighbours,
                            L = 0,
                            j;
                          L < B.length;
                          ...
                          ((j = this.graph.vertices[B[L]]), !j.positioned) &&
                            ((j.value.isConnectedToRing = !0),
                            this.createNextBond(j, P, 0));
                    }
                  },
                },
                {
                  ...
                  value: function (e, t, n, r) {
                    ...
                    this.graph.traverseTree(e, t, function (e) {
                      ...
                      for (var t = 0, i; t < e.value.anchoredRings.length; t++)
                        (i = a.rings[e.value.anchoredRings[t]]),
                          i && i.center.rotateAround(n, r);
                    });
                  },
                },
                {
                  ...
                  value: function () {
                    for (
                      ...
                      for (var o = 0, l; o < i.members.length; o++)
                        if (
                          ((l = this.graph.vertices[i.members[o]]), !t[l.id])
                        ) {
                          t[l.id] = !0;
                          ...
                          if (1 < s.length) {
                            for (
                              var g = [], d = 0;
                              d < l.value.rings.length;
                              d++
                            )
                              g.push(l.value.rings[d]);
                            e.push({ common: l, rings: g, vertices: s });
                          } else if (
                            1 === s.length &&
                    ...
                    for (var n = 0, h; n < e.length; n++)
                      if (((h = e[n]), 2 === h.vertices.length)) {
                        ...
                        var p =
                          (2 * r - this.getRing(h.rings[0]).getAngle()) / 6;
                        this.rotateSubtree(
                          c.id,
                          h.common.id,
                          p,
                        ...
                        if (!t) {
                          ...
                          if (
                            ...
                            for (var C = 0, i; C < f.length; C++)
                              if (
                                ((i = this.graph.vertices[f[C]]),
                                d.containsAll(i.value.rings, t.value.rings))
                              ) {
                                b = i;
                                break;
                              }
                          if (null === b) {
                            for (var C = 0, S; C < f.length; C++)
                              (S = this.graph.vertices[f[C]]),
                                S.positioned &&
                                  this.areVerticesInSameRing(S, t) &&
                                  k.add(l.subtract(S.position, t.position));
                            k.invert()
                              .normalize()
                      ...
                      if (null !== e.value.bridgedRing) {
                        ...
                        if (1 === L.length) {
                            ...
                            1 < this.graph.getTreeDepth(de.id, e.id)
                              ? ((de.angle = -e.angle),
                                0 <= e.angle
                                  ...
                                  : ((s.angle = -g.toRad(30)),
                                    (ue.angle = -g.toRad(90))),
                                this.createNextBond(de, e, E + de.angle),
                          ...
                          (ye.value.subtreeDepth = he),
                            ...
                            ce > he && ce > pe && ce > ve
                              ? ((ye = this.graph.vertices[L[1]]),
                                (w = this.graph.vertices[L[0]]),
                                (x = this.graph.vertices[L[2]]),
                                (y = this.graph.vertices[L[3]]))
                              : pe > he && pe > ce && pe > ve
                              ? ((ye = this.graph.vertices[L[2]]),
                                (w = this.graph.vertices[L[0]]),
                  ...
                  value: function (e) {
                    for (var t = e.neighbours, n = 0, i; n < t.length; n++)
                      if (
                        ...
                        d.containsAll(i.value.rings, e.value.rings))
                      )
                        return i;
                    return null;
                  },
                      ...
                      if (
                        ...
                        for (
                          ...
                          (j[a][0] += I.value.isStereoCenter ? 0 : 1e5),
                            (j[a][0] += this.areVerticesInSameRing(I, t)
                              ? 0
                              : 1e4),
                        ...
                        if (
                          ...
                          if (t.value.hasHydrogen)
                            ...
                            for (
                              var B = A, a = l.length - 1;
                              0 <= a && ((B = B == R ? A : R), n[l[a]] !== P);
                              a--
                            );
                ...
                },
                {
                  ...
                  value: function (e, t, n, r, a, o) {
                    ...
                    for (var d = 0; d < this.graph.getEdge(e, t).weight; d++)
                      r[o].push(1e3 * l + g);
                    for (
                      var i = this.graph.vertices[e].neighbours, d = 0;
                      d < i.length;
                      d++
                    )
                      1 !== n[i[d]] &&
                  ...
                  value: function () {
                        ...
                        if (!(1 < o || 2 > a)) {
                          ...
                          for (var r = 0, h; r < i.length; r++)
                            if (((h = i[r]), !(1 < h.getNeighbourCount()))) {
                              h.value.isDrawn = !1;
                              var p =
                                  c.maxBonds[h.value.element] -
                                  h.value.bondCount,
                                v = "";
                              h.value.bracket &&
                                ((p = h.value.bracket.hcount),
                                (v = h.value.bracket.charge || 0)),
                                t.value.attachPseudoElement(
                                  h.value.element,
                                  d ? d.value.element : null,
                                  p,
                                  v
                                );
                            }
                    ...
                    for (var e = 0; e < this.graph.vertices.length; e++) {
                      ...
                      if ("C" !== f && "H" !== f && m.isDrawn) {
                        for (
                          var b = y.neighbours, x = Array(b.length), r = 0;
                          r < b.length;
                          r++
                        )
                        ...
                        for (var r = 0, k; r < x.length; r++)
                          if (
                            ...
                            C.hasOwnProperty("0O") &&
                              C.hasOwnProperty("3C") &&
                              ((k.isDrawn = !1),
                              y.value.attachPseudoElement("Ac", "", 0));
                          }
                      }
                    }
                  },
              ...
              i(
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      for (
                        var t = [], n = this.vertices[e], r = 0;
                        r < n.neighbours.length;
                        r++
                      )
                        t.push(
                          this.vertexIdsToEdgeId[e + "_" + n.neighbours[r]]
                        );
                      return t;
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function (e, t, n, o, g) {
                      ...
                      for (u = p; u--; ) {
                        ...
                        k.positioned
                          ? ((f[u] = k.position.x), (b[u] = k.position.y))
                          : ((f[u] = t.x + Math.cos(m) * v),
                            (b[u] = t.y + Math.sin(m) * v)),
                          (x[u] = k.positioned),
                          (m += y);
                      }
                      var C = Array(p);
                      ...
                      for (var T, w, I, P, B, L, E; u--; ) {
                        ...
                        for (var D = p; D--; )
                          u !== D &&
                            ((B = f[D]),
                            (L = b[D]),
                            (E = 1 / a((T - B) * (T - B) + (w - L) * (w - L))),
                            (R[u][D] = [
                              S[u][D] * (T - B - C[u][D] * (T - B) * E),
                              S[u][D] * (w - L - C[u][D] * (w - L) * E),
                            ]),
                            (R[D][u] = R[u][D]),
                            (I += R[u][D][0]),
                            (P += R[u][D][1]));
                      ...
                      for (
                        ...
                        var U = O(),
                          G = l(U, 4);
                        for (
                          z = G[0], H = G[1], F = G[2], W = G[3], _ = H, q = 0;
                          0.1 < _ && 50 > q;
                  ...
                  },
                  {
                    ...
                    value: function (t, n, i, r) {
                      for (var a = 0, o; a < i[t].length; a++)
                        ((o = i[t][a]), o && !n[a] && t !== a) &&
                          ((n[a] = !0), r.push(a), e._ccGetDfs(a, n, i, r));
                    },
                  },
                ]
              ),
            ...
            return (
              r(e, [
                ...
                },
                {
                  ...
                  value: function () {
                    return Math.sqrt(
                      i(this.to.x - this.from.x, 2) +
                        i(this.to.y - this.from.y, 2)
                    );
                  },
                },
                {
            ...
            }),
            {
              ...
              parse: function (t, n) {
                ...
                function a(e) {
                  ...
                  for (i = e - 1; !rt[i]; ) i--;
                  for (
                    n = rt[i], n = { line: n.line, column: n.column };
                    i < e;
                ...
                throw (
                  ...
                  (function (t, n, i) {
                    ...
                    ot,
                    at < t.length ? t.charAt(at) : null,
                    at < t.length ? o(at, at + 1) : o(at, at)
                  ))
                );
              },
            }
                ...
                },
                {
                  ...
                  value: function (e, t, n, i) {
                    ...
                    for (var r = n, a = 0, o; null != r && 100 > a; )
                      (o = r),
                        t(o),
                        (r = e[r].getNextInRing(e, this.id, i)),
                        (i = o),
                        r == n && (r = null),
                        a++;
                  },
                },
                {
                  ...
                  value: function (e) {
                    for (
                      ...
                      (i = l.getVertices(e, this.id, this.neighbours[n])),
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      try {
                        for (
                          var r = this.vertices[Symbol.iterator](), a, o;
                          !(t = (a = r.next()).done);
                          t = !0
                        )
                ...
                [
                  {
                    ...
                    value: function (e, t, n, r) {
                      for (var a = null, o = 0; o < e.length; o++)
                        if (
                          ((a = e[o]),
                          (a.firstRingId === n && a.secondRingId === r) ||
                            (a.firstRingId === r && a.secondRingId === n))
                        )
                          return a.isBridge(t);
                      return !1;
                    },
                  ...
                  },
                  {
                    ...
                    value: function (e, t, r) {
                      for (var a = 0, i; a < e.length; a++)
                        if (
                          ((i = e[a]),
                          (i.firstRingId === t && i.secondRingId === r) ||
                            (i.firstRingId === r && i.secondRingId === t))
                        )
              ...
              r(e, null, [
                {
                  ...
                  value: function (t) {
                    ...
                    for (
                      var o = a.getConnectedComponents(r), l = [], s = 0;
                      s < o.length;
                      s++
                    ) {
                      for (
                        var i = o[s],
                          g = t.getSubgraphAdjacencyMatrix([].concat(n(i))),
                      ...
                      for (
                        var b = e.getPathIncludedDistanceMatrices(g),
                          ...
                          d = b.pe,
                          k = b.pe_prime,
                          C = e.getRingCandidates(x, d, k),
                          c = e.getSSSR(C, x, g, d, k, u, h, m),
                          p = 0;
                        p < c.length;
                        p++
                      ) {
                      ...
                      for (n = t; n--; )
                        for (i = t; i--; ) {
                          ...
                          if (h > c) {
                            ...
                            if (h === c + 1)
                              for (
                                o[n][i] = [a[n][i].length], s = a[n][i].length;
                                s--;

                              )
                                for (
                                  o[n][i][s] = [a[n][i][s].length],
                                    l = a[n][i][s].length;
                                  l--;

                                )
                                  for (
                                    o[n][i][s][l] = [a[n][i][s][l].length],
                                      g = a[n][i][s][l].length;
                                    g--;
                        ...
                        if (
                          ...
                          (o =
                            0 === n[l][i].length
                              ? 2 * e[l][i]
                              : 2 * (e[l][i] + 0.5)),
                            o != Infinity && a.push([o, t[l][i], n[l][i]]);
                    return (
                      a.sort(function (e, t) {
                        return e[0] - t[0];
                      }),
                    ...
                    for (var d = [], u = [], h = 0; h < t.length; h++)
                      if (0 != t[h][0] % 2)
                        for (var i = 0, c; i < t[h][2].length; i++) {
                          ...
                          if (
                            (e.getBondCount(v, r) !== v.size ||
                              e.pathSetsContain(d, v, c, u, l, s) ||
                              (d.push(v), (u = u.concat(c))),
                            d.length > g)
                          )
                            return d;
                        }
                        ...
                        for (var y = 0, m; y < t[h][1].length - 1; y++) {
                          ...
                          if (
                            (e.getBondCount(f, r) !== f.size ||
                              e.pathSetsContain(d, f, m, u, l, s) ||
                              (d.push(f), (u = u.concat(m))),
                            d.length > g)
                          )
                            return d;
                        }
                  ...
                  value: function (t, n, r, a, o, l) {
                    ...
                    for (s = r.length; s--; )
                      for (var d = a.length; d--; )
                        ((r[s][0] === a[d][0] && r[s][1] === a[d][1]) ||
                          (r[s][1] === a[d][0] && r[s][0] === a[d][1])) &&
                          i++,
                          i === r.length && (g = !0);
                    var u = !1;
                    if (g) {
              ...
              i(e, [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      (n = e
                        ? l.subtract(this.position, e)
                        : l.subtract(this.position, this.previousPosition)),
                ...
                },
                {
                  ...
                  value: function (e) {
                    for (
                      var t = this.getDrawnNeighbours(e), n = [], o = 0;
                      o < t.length;
                      o++
                    )
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    for (var r = this.getNeighbours(), a = 0; a < r.length; a++)
                      if (
                        o.contains(e[r[a]].value.rings, { value: t }) &&
                        r[a] != n
                      )
                        return r[a];
                    return null;
